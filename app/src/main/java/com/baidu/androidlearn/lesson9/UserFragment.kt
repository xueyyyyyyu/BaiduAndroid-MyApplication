...
import com.baidu.androidlearn.lesson9.databinding.FragmentUserBinding
import com.baidu.androidlearn.lesson9.user.User
import com.baidu.androidlearn.lesson9.user.UserDatabase
...
class UserFragment : Fragment() {
    ...
    private fun loadImage(url: String?) {
        ...
        if (!url.isNullOrEmpty()) {
            ...
            Glide.with(this)
                .load(R.drawable.error_image) // 这里设置默认头像的资源ID
                .into(binding.avatarImageView)
        }
    }
