...
class NewsRepository {
    ...
    private fun buildFakeNewsTopics(): List<NewsTopic> {
        return listOf(
            NewsTopic(
                title = "1",
                content = "悟空集齐了七龙珠后，向神龙许了想要挑战宇宙最强强者的愿望",
            ...
            NewsTopic(
                title = "2",
                content = "最新！台风“杜苏芮”将于7月28日在闽粤沿海登陆",
